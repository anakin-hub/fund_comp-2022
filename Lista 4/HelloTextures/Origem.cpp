...
//#endif
	...
	GLuint backID = loadTexture("../textures/back.png");
	GLuint treeID = loadTexture("../textures/tree_1.png");
	GLuint dummyID = loadTexture("../textures/dummy.png");
	GLuint archerID = loadTexture("../textures/archer.png");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::scale(model, glm::vec3(800.0, 600.0, 1.0));
		...
		//Desenhando modelo de arvore
		model = glm::mat4(1); //matriz identidade
		model = glm::translate(model, glm::vec3(620.0, 340.0, 0));
		model = glm::rotate(model, /*(float)glfwGetTime()*/ glm::radians(180.0f), glm::vec3(0, 0, 1));
		model = glm::scale(model, glm::vec3(128.0, 128.0, 1.0));
		...
		//Desenhando modelo de arvore
		model = glm::mat4(1); //matriz identidade
		model = glm::translate(model, glm::vec3(420.0, 200.0, 0));
		model = glm::rotate(model, /*(float)glfwGetTime()*/ glm::radians(180.0f), glm::vec3(0, 0, 1));
		model = glm::scale(model, glm::vec3(128.0, 128.0, 1.0));
		modelLoc = glGetUniformLocation(shader.ID, "model");
		glUniformMatrix4fv(modelLoc, 1, FALSE, glm::value_ptr(model));
		...
		//Desenhando modelo de arvore
		model = glm::mat4(1); //matriz identidade
		model = glm::translate(model, glm::vec3(180.0, 250.0, 0));
		model = glm::rotate(model, /*(float)glfwGetTime()*/ glm::radians(180.0f), glm::vec3(0, 0, 1));
		model = glm::scale(model, glm::vec3(128.0, 128.0, 1.0));
		modelLoc = glGetUniformLocation(shader.ID, "model");
		glUniformMatrix4fv(modelLoc, 1, FALSE, glm::value_ptr(model));
		...
		//Desenhando dummy training
		model = glm::mat4(1); //matriz identidade
		model = glm::translate(model, glm::vec3(150.0, 150.0, 0));
		model = glm::rotate(model, /*(float)glfwGetTime()*/ glm::radians(180.0f), glm::vec3(0, 0, 1));
		model = glm::scale(model, glm::vec3(64.0, 64.0, 1.0));
		modelLoc = glGetUniformLocation(shader.ID, "model");
		glUniformMatrix4fv(modelLoc, 1, FALSE, glm::value_ptr(model));
		...
		//Desenhando archer
		model = glm::mat4(1); //matriz identidade
		model = glm::translate(model, glm::vec3(400.0, 150.0, 0));
		model = glm::rotate(model, /*(float)glfwGetTime()*/ glm::radians(180.0f), glm::vec3(0, 0, 1));
		model = glm::scale(model, glm::vec3(64.0, 64.0, 1.0));
		modelLoc = glGetUniformLocation(shader.ID, "model");
		glUniformMatrix4fv(modelLoc, 1, FALSE, glm::value_ptr(model));

		glBindTexture(GL_TEXTURE_2D, archerID);
