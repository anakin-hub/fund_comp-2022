...
//#endif
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//LINHA DE CHAMADA DE DESENHO PADRÃO, USE ESTA QUANDO NÃO FOR PARA TESTAR OS EXERCICIOS 4 E 5
		//glDrawArrays(GL_TRIANGLE_FAN, 0, 86);
		
		//EXERCICIO 4, DESCOMENTE PARA USAR ELE, COMENTE QUANDO NÃO ESTIVER MAIS EM USO
